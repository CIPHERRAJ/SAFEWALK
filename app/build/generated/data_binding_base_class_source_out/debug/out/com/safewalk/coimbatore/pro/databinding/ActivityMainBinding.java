...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialCardView cardJunctions;
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.cardJunctions;
      MaterialCardView cardJunctions = ViewBindings.findChildViewById(rootView, id);
      if (cardJunctions == null) {
        break missingId;
      }
